                        ...
                        <div class="flex">
                            ...
                            <div class="flex items-center flex-shrink-0">
                                <inertia-link :href="route('dashboard')">
                                    <breeze-application-logo class="block w-auto h-9" />
                                </inertia-link>
                            </div>
...
<script>
    ...
    import BreezeNavLink from '@/Components/Breeze/NavLink'
    import BreezeResponsiveNavLink from '@/Components/Breeze/ResponsiveNavLink'
